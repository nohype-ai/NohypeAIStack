...
| [Brewfile.rb](Brewfile.rb) | `mack update` updates/installs listed packages |
...
| [ai/coding/grok/](ai/coding/grok/) | `mack update` copies present files/dirs into `~/.grok/` (overwrite, no merge) |
