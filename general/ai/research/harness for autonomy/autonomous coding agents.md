...
>Prompt:
>1) [@to do.md (6:11)](../README.md) i have prioritized this so high because it's the core of the 10x or 100x developer promise. it's where the multiplication actually happens, and i want to know how to even approach it in practice and see how it maybe fails without the supporting stuff in place yet (like evals etc.).
>
